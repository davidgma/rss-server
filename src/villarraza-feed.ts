...
import { Parser } from './villarraza-parser';
import { writeFile } from 'fs';
import { homedir } from 'os';

export class VillarrazaFeed {

    private feed: Feed;
    private parser: Parser = new Parser();
    private nameCode = "villarraza";
    private title = "Victor Villarraza readings";

    public constructor() {
        this.feed = new Feed({
            title: this.title,
            description: "Audio files from Victor Villarraza's readings with the (louder) parts edited out.",
